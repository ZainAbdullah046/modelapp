...
import 'package:modelapp/LoginScreen.dart';
import 'package:modelapp/SignUpScreen.dart';
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            Image.asset('Assests/white.PNG', height: imageHeight),
            ...
            SizedBox(height: screenSize.height * 0.03),
            Image.asset('Assests/chids.PNG', height: imageHeight),
          ],
        ),
      ),
    );
